...
#+NAME: thumbs
| U_NP  | U_NP  | ESC   | TAB   | A     | I     | ENT   | DEL   | U_NP  | U_NP  |
...
| U_BUTTON | U_MEDIA   | U_NAV       | U_MOUSE    |         |       | U_SYM      | U_NUM       | U_FUN     | U_BUTTON |
| U_NP     | U_NP      | U_MEDIA     | ALGR       | U_NP    | U_NP  | U_NUM      | U_FUN       | U_NP      | U_NP     |
...
| LCTL       | Q          | F          | E          | 1          |
| SPC        | A          | W          | D          | 2          |
| LSFT       | TG(U_GAME) | S          | R          | 3          |
| U_NP       | U_NP       | ESC        | TAB        | LALT       |
